...
class CardDepartementWidget extends StatelessWidget {
  const CardDepartementWidget(
      {Key? key,
      required this.color,
      required this.title,
      ...
      child: InkWell(
        ...
        child: Ink(
          child: Container(
            ...
            width: widthSized,
            // height: Responsive.isDesktop(context) ? size.height / 3 : size.height,
            child: Column(
              children: [
                Image.asset(image, height: 200, fit: BoxFit.fill),
                const SizedBox(height: p8),
                Text(title, maxLines: 1, style: headline6),
