...
class FormationRessource extends StatefulWidget {
  const FormationRessource({Key? key}) : super(key: key);

  @override
  State<FormationRessource> createState() => _FormationRessourceState();
}

class _FormationRessourceState extends State<FormationRessource> {
