...
class PartenaireRessource extends StatefulWidget {
  const PartenaireRessource({Key? key}) : super(key: key);

  @override
  State<PartenaireRessource> createState() => _PartenaireRessourceState();
}

class _PartenaireRessourceState extends State<PartenaireRessource> {
