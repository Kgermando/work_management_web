...
class DevenirParternaireRessource extends StatefulWidget {
  const DevenirParternaireRessource({Key? key}) : super(key: key);

  @override
  State<DevenirParternaireRessource> createState() =>
      _DevenirParternaireRessourceState();
}

class _DevenirParternaireRessourceState
    extends State<DevenirParternaireRessource> {
