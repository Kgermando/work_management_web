...
class IndustrieGE extends StatefulWidget {
  const IndustrieGE({Key? key}) : super(key: key);

  @override
  State<IndustrieGE> createState() => _IndustrieGEState();
}

class _IndustrieGEState extends State<IndustrieGE> {
