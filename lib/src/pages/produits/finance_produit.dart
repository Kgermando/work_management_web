...
class FinanceProduit extends StatefulWidget {
  const FinanceProduit({Key? key}) : super(key: key);

  @override
  State<FinanceProduit> createState() => _FinanceProduitState();
}

class _FinanceProduitState extends State<FinanceProduit> {
