...
class ArchivesProduit extends StatefulWidget {
  const ArchivesProduit({Key? key}) : super(key: key);

  @override
  State<ArchivesProduit> createState() => _ArchivesProduitState();
}

class _ArchivesProduitState extends State<ArchivesProduit> {
