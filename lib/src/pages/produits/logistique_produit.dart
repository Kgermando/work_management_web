...
class LogistiqueProduit extends StatefulWidget {
  const LogistiqueProduit({Key? key}) : super(key: key);

  @override
  State<LogistiqueProduit> createState() => _LogistiqueProduitState();
}

class _LogistiqueProduitState extends State<LogistiqueProduit> {
