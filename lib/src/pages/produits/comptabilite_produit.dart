...
class ComptabiliteProduit extends StatefulWidget {
  const ComptabiliteProduit({Key? key}) : super(key: key);

  @override
  State<ComptabiliteProduit> createState() => _ComptabiliteProduitState();
}

class _ComptabiliteProduitState extends State<ComptabiliteProduit> {
